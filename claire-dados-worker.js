      ...
      if (url.pathname.endsWith('/save') && request.method === 'POST') {
        ...
        try {
          ...
          if (prevRaw) {
            ...
            const MERGE_POR_ID = ['nx_manutencoes','nx_tasks','nx_plantao','nx_projetos','nx_compras','nx_extras','nx_limpeza','nx_caucao','nx_despesas','nx_anotacoes_controle','nx_superhost','nx_cancelamentos','nx_imoveis'];
